...
<head>
	...
	<title>@yield('vender_page_title')</title>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
			...
			<li class="sidebar-header">
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">review</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="shopping-bag"></i> <span class="align-middle">order history</span>
            </a>
					</li>
